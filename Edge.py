...
LocationCamera = bproc.sampler.shell(center=[0,0,0], radius_min=8, radius_max=8, elevation_min=25, elevation_max=89)
...
#mat1.node_tree.nodes["Principled BSDF"].inputs[0].default_value = np.array([1,1,1,1])
